...
export interface Booking{id:string;customerName:string;email:string;phone:string;serviceType:ServiceType;durationHours:number;urgency:Urgency;status:BookingStatus;estimate:number;assignee:string|null;notes:string;createdAt:string}
